...
const AdminLayout = () => {
  ...
  return (
    ...
    <div className="flex h-screen overflow-hidden transition-colors duration-500 bg-[#FFFAF0] dark:bg-[#050505] text-slate-900 dark:text-white font-sans selection:bg-orange-500/30">
      ...
      {/* 1. SIDEBAR (Fixed Width, No Scroll) */}
      <aside className={`
      ...
      `}>
        <div className="h-full flex flex-col p-6">
          ...
          <div className="pt-6 border-t border-slate-200 dark:border-white/5 space-y-2">
            ...
            <button className="flex items-center gap-4 w-full px-4 py-3 text-red-500 font-bold text-sm hover:bg-red-50 dark:hover:bg-red-500/10 rounded-xl transition-all">
      ...
      <main className="flex-1 flex flex-col min-w-0 h-full relative">
        ...
        {/* STICKY HEADER */}
        <header className="h-20 border-b border-slate-200 dark:border-white/5 flex items-center justify-between px-6 lg:px-10 bg-white/80 dark:bg-[#050505]/80 backdrop-blur-xl z-30 shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center relative group">
              ...
              <input 
                ...
                className="bg-slate-100 dark:bg-white/5 border border-transparent focus:border-orange-500/30 rounded-2xl pl-12 pr-4 py-2.5 text-sm outline-none transition-all w-64 lg:w-96"
              />
            </div>
          </div>

          <div className="flex items-center gap-3 lg:gap-6">
            <div className="flex items-center gap-3 bg-slate-100 dark:bg-white/5 px-4 py-2 rounded-2xl border border-slate-200 dark:border-white/5">
            ...
            <button className="relative p-2 text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
              <Bell size={22} />
              <span className="absolute top-1 right-1 w-2 h-2 bg-orange-600 rounded-full ring-4 ring-white dark:ring-[#050505]" />
            </button>
            ...
            <div className="flex items-center gap-3">
              <div className="text-right hidden sm:block">
                <p className="text-xs font-black leading-none uppercase tracking-tighter">CHIRABRATA</p>
                <p className="text-[10px] font-bold text-orange-500 uppercase mt-1 tracking-widest">Super Admin</p>
              </div>
              <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-orange-500 to-red-600 shadow-lg border border-white/20" />
            </div>
          </div>
        </header>
